...
const RISK_TERMS = ["OOC", "시스템", "기록지", "설정", "요약", "이전 대화", "AI", "모델", "검열", "제3자 개입", "분위기 반전", "복선 회수", "상황 주도", "장면 전환", "시간 경과", "사건 발생", "이어서 진행", "새로운 존재", "현재 장면", "예상치 못한 분위기", "과거의 단서", "직접 상황", "새로운 장소", "어느 정도 시간", "이전 서사", "�"];
